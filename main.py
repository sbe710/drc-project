...
parser.add_argument('--image_folder', default='./Results/CropWords/',
...
if args['language'] == "english":
    savedModelForRecognition = './pretrained_model/TPS-ResNet-BiLSTM-Attn.pth'
    characterBank = '0123456789abcdefghijklmnopqrstuvwxyz'
else:
    savedModelForRecognition = './pretrained_model/best_accuracy.pth'
...
subprocess.call(['python3', "recog.py", f"--image_folder={args['image_folder']}", f"--saved_model={savedModelForRecognition}", f"--character={characterBank}"])
